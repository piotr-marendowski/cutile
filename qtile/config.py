...
widget_defaults = dict(
    ...
    padding = 0,
    margin = 0,
    background = [colors["mauve"], colors_pink["pink"]],
...
screens = [
    Screen(
        top = bar.Bar([
            widget.Image(
                filename = "/home/Kenny/.config/qtile/assets-chibi/chibi3.png",
            ...
            widget.GroupBox(
                ...
                borderwidth = 4,
                this_current_screen_border = colors_pink["magenta"],      # block fill color
                block_highlight_text_color = colors["background"],      # block text color
                active = colors["background_darker"],                   # text color
                other_screen_border = colors_pink["pink"],                   # block fill color other screens
            ...
            widget.TaskList(
                ...
                icon_size = 18,
                max_title_width = 150,
                margin = 4,                   # match to center
                padding = 5,                  # size of a block
                fontsize = 12,
                font = "JetBrainsMono",
                border = colors_pink["fuscia"],      # fill current window
                foreground = colors["background"],
            ...
            # RIGHT SIDE
            widget.Image(
                filename = '~/.config/qtile/assets-chibi/chibi1.png',
                #margin = 7,
                mouse_callbacks = {'Button3': lazy.spawn("spotify")},
                decorations = [
                    RectDecoration(
                        colour = colors_pink["watermelon"],
                        **decoration_defaults,
                    )
                ],
            ),
            ...
            widget.Image(
                filename = '~/.config/qtile/assets-chibi/chibi2.png',
                margin = 4,
            ...
            #    decorations = [
            #        RectDecoration(
            #            colour = colors_pink["strawberry"],
            #            **decoration_defaults,
            #        )
            #    ],
            #),
            widget.Image(
                filename = '~/.config/qtile/assets-chibi/chibi6.png',
                margin = 3,
                decorations = [
                    RectDecoration(
                        colour = colors_pink["strawberry"],
            ...
            widget.Image(
                filename = '~/.config/qtile/assets-chibi/chibi7.png',
                margin = 4,
            ...
            widget.Image(
                filename = '~/.config/qtile/assets-chibi/chibi8.png',
                mouse_callbacks = {'Button1': lazy.spawn("shutdown now"),
                                   'Button3': lazy.spawn("reboot")},
                #margin = 7,
            ),
            ],
            35, # WIDTH
